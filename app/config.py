...
class BaseConfig:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'sqlite:///DudeWheresMyLambo.db')
    ...
    LOG_INFO_FILE = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'log', 'info.log')
    LOG_CELERY_FILE = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'log', 'celery.log')
...
class ProductionConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'postgresql://user:password@localhost:5432/dwml_production')
