...
class TestCryptoEndpoints:
    ...
    def test_process_request_success(self, client):
        ...
        with pytest.MonkeyPatch().context() as m:
            ...
            m.setattr('app.utils.data_collector.DataCollector.driver_logic', lambda self: {"profit": 1000})
            m.setattr('app.utils.graph_creator.GraphCreator.driver_logic', lambda self: [{"x": "2023-01-01", "y": 1000}])
            
            response = client.get('/api/v1/project/core/process_request?symbol=BTC&investment=1000')
    ...
    def test_process_request_invalid_params(self, client):
        ...
        response = client.get('/api/v1/project/core/process_request?symbol=&investment=invalid')
